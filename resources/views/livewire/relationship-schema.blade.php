<relationship-schema>
  ...
  <button type="button" wire:click.prevent="addRelationship" class="btn btn-outline-primary ml-1 ms-1 add-relationship-schema-button">+ Add Relationship</button>
...
@push('after_scripts')
  <script>
    window.addEventListener('confirmRelationshipDelete', (e) => {
      ...
      if (e.detail[0].callback == 'removeRelationshipAndColumn') {
