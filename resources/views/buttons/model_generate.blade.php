...
<div class="btn-group dropdown">
    <button class="btn btn-sm btn-warning dropdown-toggle {{ $entry->can_generate_factory || $entry->can_generate_seeder || $entry->can_generate_crud ? '' : 'disabled' }}" type="button" data-toggle="dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        Generate
    </button>
