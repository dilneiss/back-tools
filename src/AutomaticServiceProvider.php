...
trait AutomaticServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        if (isset($this->livewireComponents) && ! empty($this->livewireComponents)) {
            foreach ($this->livewireComponents as $key => $class) {
                app('livewire')->component($key, $class);
            }
        }
    }
    ...
    public function register(): void
    {
        ...
        if (isset($this->singleton) && ! empty($this->singleton)) {
            foreach ($this->singleton as $interface) {
                $this->app->singleton($interface, function () use ($interface) {
