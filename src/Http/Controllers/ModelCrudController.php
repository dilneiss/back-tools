...
class ModelCrudController extends CrudController
{
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('relationships')
            ...
            ->wrapper([
                'class' => 'form-group col-sm-11 ml-4 ms-4 pl-4 ps-4 mb-0 pb-3 border-left border-start',
            ]);
        ...
        CRUD::field('run_migration')
            ...
            ->label('Run migration')
            ->wrapper([
                'class' => 'form-group col-sm-11 ml-4 ms-4 pl-4 ps-4 pb-1 mb-2 border-left border-start',
                'toggler' => 'generate_migration',
            ])
            ->default(true);
        ...
        CRUD::field('generate_factory')
            ...
            ->wrapper([
                'class' => 'form-group col-sm-12 mb-1',
            ]);
