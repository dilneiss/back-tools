...
class CustomFile implements Arrayable, Jsonable, JsonSerializable
{
    ...
    public $file_path_absolute;

    public $file_path_relative;

    public $file_path_from_base;

    public $file_name;

    public $file_name_without_extension;

    public $file_name_with_extension;

    public $file_last_accessed_at;

    public $file_last_modified_at;

    public $file_last_changed_at;
    ...
    public $class_path_with_extension;
    ...
    {
        return trait_exists($this->inferClassPath());
    }
